...
<title>课件学习</title><link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet" /><link href="https://cdn.bootcss.com/materialize/0.100.2/css/materialize.min.css" rel="stylesheet" />
</head>
<body>
<%=batch_name+":"%>
<br>
...
<a href="/OnlineStudy/manager/studymanager/start.jsp?url=<%=((CourseWare)coursewaresList.get(i)).getUrl() %>">
<%=i+1+"、"+((CourseWare)coursewaresList.get(i)).getCourseware_name()%></a> 
<br>
<%}%>
<%}%>
