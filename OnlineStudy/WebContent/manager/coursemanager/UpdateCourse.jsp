...
<title>课程修改页面</title><link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet" /><link href="https://cdn.bootcss.com/materialize/0.100.2/css/materialize.min.css" rel="stylesheet" />
</head>
<body>
<div>修改课程</div>
<form:form action="/OnlineStudy/updateCourseAction" method="post" modelAttribute="modifycourse">
